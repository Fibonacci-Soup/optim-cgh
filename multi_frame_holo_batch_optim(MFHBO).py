#!/usr/bin/env python3
"""
Copyright(c) 2023 Jinze Sha (jinze.sha@cantab.net)
Centre for Molecular Materials, Photonics and Electronics, University of Cambridge
All Rights Reserved.

This is the python script for Multi Frame Holograms Batched Optimization (MFHBO) for binary phase spatial light modulators.
Please make reference of this code to: https://doi.org/10.1038/s41598-024-70428-0
"""
